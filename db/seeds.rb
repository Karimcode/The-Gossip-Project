...
anon = User.create!(first_name: 'anonymous', last_name: 'none', description: 'this is empty', email: 'anon@nomail.com', age: 12, city_id: rand(City.all.first.id..City.all.last.id))
